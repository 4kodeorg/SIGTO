        ...
        <div class="navcontainer">
            <nav class="nav">
                <div class="nav-upper-options">
                    ...
                    <svg width="36px" height="36px" viewBox="0 0 16 16" 
                    fill="currentColor" x="128" y="128" role="img" 
                    style="display:inline-block;vertical-align:middle" xmlns="http://www.w3.org/2000/svg">
                    <g fill="currentColor"><path fill="currentColor" d="m1 2l1-1h12l1 1v12l-1 1H2l-1-1V2Zm1 
                    0v12h3V2H2Zm4 0v8h8V2H6Z"/></g>
                </svg></svg>
                        <h3> Panel</h3>
                    </div>
        ...
        <div class="main">
            ...
            <div class="box-container">
                ...
                <div class="box box1">
                    ...
                    <svg width="56px" height="56px" viewBox="0 0 16 16" 
                    fill="currentColor" x="128" y="128" role="img" xmlns="http://www.w3.org/2000/svg">
                    <g fill="currentColor"><path fill="currentColor" d="M8 6.003a2.667 2.667 0 1 1 
                    ...
                    0 0 0-10.995.004a.5.5 0 0 1-.97-.243A6.669 6.669 0 0 1 8 3.667Z"/></g>
                    </svg>
                </div>
                ...
                <div class="box box2">
                    ...
                    <svg width="56px" height="56px" viewBox="0 0 16 16" fill="currentColor" 
                    x="128" y="128" role="img" xmlns="http://www.w3.org/2000/svg"><g 
                    fill="currentColor"><path fill="currentColor" d="M10.54 2c.289.001.57.088.81.25a1.38
                ...
                <div class="box box3">
                    ...
                    <svg width="56px" height="56px" viewBox="0 0 16 16" fill="currentColor" x="128" y="128" 
                    ...
                    12H14.5l.5-.5v-9l-.5-.5zm-.5 9H7.5l-.354.146L5 13.293V11.5l-.5-.5H2V3h12v8z"/></g>
                    </svg>
                </div>
                ...
                <div class="box box4">
                    ...
                    viewBox="0 0 16 16" fill="currentColor" x="128" y="128" role="img" 
                    xmlns="http://www.w3.org/2000/svg"><g fill="currentColor"><path fill="currentColor" 
                    fill-rule="evenodd" d="m14.431 3.323l-8.47 10l-.79-.036l-3.35-4.77l.818-.574l2.978 
                    4.24l8.051-9.506l.764.646z" clip-rule="evenodd"/></g>
                    </svg>
                </div>
            </div>
