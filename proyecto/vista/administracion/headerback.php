...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary py-4">
        <div class="container-fluid px-4">
            ...
            <div class="header-options">
                ...
                2.032-2.53 6.71.948 6.71h10.464c.04 2.76 2.281 4.985 5.049 4.985s5.01-2.226 5.049-4.984h10.463c3.479 0 3.563-4.68.95-6.71Z" />
                    </g>
                </svg>
                ...
                <svg class="p-1" width="36px" height="36px" viewBox="0 0 1200 1200" fill="currentColor" x="128" y="128" role="img"
                    ...
                    <g fill="currentColor">
                        <path fill="currentColor" d="M605.096 
                ...
                12.135-28.393 28.709V1200h-164.68V831.057c-.98-159.475 99.901-300.087 259.137-301.269h397.015z" />
                    </g>
                </svg>
            </div>
    ...
    <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
        <svg width="40px" height="40px" viewBox="0 0 24 24" fill="currentColor" x="128" y="128" role="img" xmlns="http://www.w3.org/2000/svg">
            <g fill="currentColor">
                ...
                <nav class="nav">
                    ...
                    0v12h3V2H2Zm4 0v8h8V2H6Z" />
                            ...
                            <svg width="36px" height="36px" viewBox="0 0 24 24"
                                ...
                                <g fill="currentColor">
                                    <g fill="none" stroke="currentColor" stroke-linejoin="round"
                                        stroke-width="2">
                                        <path stroke-linecap="round" d="M11.029 2.54a2 2 0 0 1 1.942 0l7.515
                        4.174a1 1 0 0 1 .514.874v8.235a2 2 0 0 1-1.029 1.748l-7 3.89a2 2 0 0 1-1.942 0l-7-3.89A2
                        2 0 0 1 3 15.824V7.588a1 1 0 0 1 .514-.874L11.03 2.54Z" />
                        ...
                        <a href="/admin/empresa" class="nav-option option4">
                            ...
                            64l163.96 37.546l-6.574 11.57H64.15l-9.823-9.383z" />
                                </g>
                            </svg>
                            <h3> Empresa</h3>
                        </a>
