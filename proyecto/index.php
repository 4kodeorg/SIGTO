...
<body>
    <header class="header-commerce">
        <div class="div-for-container">
        <nav class="nav-for">
            <h1>youCommerce</h1>
            <form class="form-for" action="" method="get">
                <label for="busqueda"></label>
                <input class="input-search" type="text" id="busqueda" name="buscar" placeholder="Encontra todo lo que buscas acá">
                <button class="button-search" type="submit"><svg width="36px" 
                    height="36px" viewBox="0 0 24 24" fill="currentColor" x="128" y="128" role="img" 
                    xmlns="http://www.w3.org/2000/svg">
                    <g fill="currentColor"><path fill="currentColor" fill-rule="evenodd" 
                        d="M14.385 15.446a6.75 6.75 0 1 1 1.06-1.06l5.156 5.155a.75.75 0 1 1-1.06 
                        1.06l-5.156-5.155Zm-7.926-1.562a5.25 5.25 0 1 1 7.43-.005l-.005.005l-.005.004a5.25
                         5.25 0 0 1-7.42-.004Z" clip-rule="evenodd"/></g></svg>
                </svg></button>
            </form>
        </nav>
        </div>
